                ...
                <div class="row justify-content-center">
                    <div class="col-md-4">
                        <form id="loginForm" class="card p-4">
                            ...
                            <button id="loginBtn" type="submit" class="btn btn-primary w-100"><i class="fa-solid fa-right-to-bracket"></i> Log In</button>
                            <button id="login42Btn" type="button" class="btn btn-primary w-100 OAuth"><img src="imgs/42_logo.png" id="oauth-logo"> Login In with 42</button>
							<div class="mt-3" id="signup-link">
								Don't have an account? <button type="button" id="signup-btn"> Sign up</button>
							</div>
                        </form>
                    </div>
                </div>
