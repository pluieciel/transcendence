...
from api.views import SignupConsumer, LoginConsumer, UpdateConsumer, ProfileConsumer, ProfileConsumer2, HandleOAuthConsumer, AvatarConsumer, Login2FAConsumer, Generate2FAConsumer, Enable2FAConsumer
