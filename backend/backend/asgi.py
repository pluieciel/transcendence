...
from api.views import SignupConsumer, LoginConsumer, UpdateConsumer, ProfileConsumer, ProfileConsumer2, LoginOAuthConsumer, AvatarConsumer, Login2FAConsumer, Generate2FAConsumer, Enable2FAConsumer, OAuthConsumer, getPreferences
from api.views2 import RemoveConsumer, setNewUsername, setPreferences
